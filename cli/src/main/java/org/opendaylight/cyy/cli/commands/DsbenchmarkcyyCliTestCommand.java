 ...
 */
package org.opendaylight.cyy.cli.commands;
...
public class DsbenchmarkcyyCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(DsbenchmarkcyyCliTestCommand.class);
    protected final DsbenchmarkcyyCliCommands service;

    public DsbenchmarkcyyCliTestCommand(final DsbenchmarkcyyCliCommands service) {
